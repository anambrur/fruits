...
import { getClients } from "../Reducer/counterSlice";

export default function OurClinetSaying() {
  const clients = useSelector((state) => state.counter.clients);
  // console.log(clients);
                    ...
                    <div className="position-relative">
                      ...
                      <div className="d-flex align-items-center flex-nowrap">
                        ...
                        <div className="ms-4 d-block">
                          <h4 className="text-dark">{d.client_name}</h4>
                          <p className="m-0 pb-3">{d.profession}</p>
